...
# Konfigurasi mongodb
client = pymongo.MongoClient("mongodb+srv://suqyarohmatin:caruban123@cluster0.ieqi5kn.mongodb.net/?retryWrites=true&w=majority")

# Konfigurasi database
db = client['location']

# Konfigurasi koleksi
my_collections = db['track_location']
import json
